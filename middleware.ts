...
export async function middleware(request: NextRequest) {
  ...
  // Keep the edge layer lightweight and rely on the server-side auth helpers
  // for signature validation and RBAC. This avoids role-entry redirects caused
  // by middleware/runtime mismatches while preserving route protection.
  if (!sessionToken) {
    return NextResponse.next();
  }
